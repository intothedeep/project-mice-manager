...
INSERT INTO mates (origin_mate_id,mother_mouse_id,father_mouse_id,status,occurred_at,actor_id)
SELECT max(origin_mate_id),(SELECT mom FROM p),(SELECT dad FROM p),'delivered','2026-10-22',(SELECT prof FROM w) FROM mates;
