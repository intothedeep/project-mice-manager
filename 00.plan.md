...
- **Authorization (data-driven permissions) — schema lands P1, switchover P2 (added 2026-09-13, user):**
  ...
  →todo/→doing, professor with →todo/→doing/→done/→verified/→cancelled + case/create.
  ...
  removed after parity. OPEN: (a) RESOLVED 2026-09-13 (user): staff must NOT have
  `doing→done` — staff is todo/doing only, done/verified/cancel are professor's
  (`taskFlow.ts` already updated); (b) RESOLVED 2026-09-13 (user): use TARGET-ONLY grants
