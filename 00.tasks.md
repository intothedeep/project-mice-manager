...
### P0.7 Litter recording + auto tasks — P0-b (MVP v0.2) — IN PROGRESS (v1 [x] · P0.7-b steps 1,2,3,8 [x], 4 = GATE, 5–7 + 9–10 [ ] · 6 base tasks [ ])
...
> Remaining: `composeMouseIdentity` (5, needs Q45 for `+offset`), punch mutations
> (6, 7), label-projection cleanup (9), punch UI (10). Base P0-b: litter-code
