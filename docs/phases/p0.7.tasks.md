...
(`lib/punchMutations.ts`) **and the inline sex editor** (its design question is
DECIDED by the owner 2026-09-22 — the control goes in the MOUSE-DETAIL DRAWER,
not the grid cell). **Step 6 is now BLOCKED-BY the NEW step 6a** (punch history
...
**6a and** step 6 (all three touch `packages/types/src/index.ts`). Plus one recorded-only, no-AC item at the end (`NewTaskDialog` importing
...
- [~] Inline `sex` editor — **IN PROGRESS, developer dispatched 2026-09-22.**
      **NEW SCOPE, surfaced 2026-09-22 by the 9b AC
      ...
      goes was the one DESIGN question here and it is **DECIDED by the OWNER,
      2026-09-22: the control goes in the MOUSE-DETAIL DRAWER, not the grid
      cell.** (Supersedes this task's earlier "grid cell vs. drawer vs. both, not
      decided here".) UNBLOCKED 2026-09-22: its blocker 9b is DONE
      ...
      9a removed.
      AC: a user can change sex to M, F or U **from the mouse-detail drawer**
...
- [ ] 10. Punch add/remove UI in the mouse-detail drawer (location picker,
      ...
      **THIS AC IS NOT STALE UNDER OPTION B AND DID NOT CHANGE** (recorded so it
      ...
      (ii) **OWNER PROPOSAL 2026-09-22, recorded verbatim, attributed to the
      system-architect who is ruling on it:** *"when babies came to us, they
      ...
      asserts a physical mark that an untagged pup does not have. No AC here on
      purpose: do not invent the fix before the ruling.
