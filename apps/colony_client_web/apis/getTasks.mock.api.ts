...
export const SEED_CASES: SeedCaseRow[] = [
    {
        ...
        // animal, not a second mouse). A mouse-subject case stores NO label:
        // subjectMouseId is the whole subject, and the displayed name (base +
        // ".N") is resolved from it by buildMouseLabelIndex() at read time.
        id: 1,
    ...
    },
    {
        ...
        subjectKind: 'mouse' as TaskSubjectKind,
        subjectLabel: null,
        subjectMouseId: 402, // metaId: F6AYL in PlpCre;Ai14 cage 2502 slot B8
